...
- In this example `Education` is a good _predictor_ of `Wage`.

- Nevertheless, the estimate of the causal effect will be confounded by _unobserved_ `Ability`.

> In general, causal inference always and everywhere depends on _assumptions_ about the DGP (i.e., the data never "speaks for itself").


```{r dag2, fig.show='hide', echo = FALSE, fig.width=1, fig.height=1, out.width='30%'}
g <- dagitty('dag {
    Ability   [pos="1,0"]
    Education [pos="0,1"]
    Wage      [pos="2,1"]
